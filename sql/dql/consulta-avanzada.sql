...
========================================================
*/
-- Consulta 1: Obtener sedes mediante una lista estática de IDs de ciudad
SELECT sede_id, nombre_sede, ciudad_id
FROM sedes
WHERE ciudad_id IN ('C01', 'C02', 'C03');

-- Consulta 2: Obtener sedes usando una subconsulta basada en nombres de ciudades
SELECT nombre_sede
FROM sedes
WHERE ciudad_id IN (
    SELECT ciudad_id 
    FROM ciudades
    WHERE nombre_ciudad IN ('Madrid', 'Barcelona')
);
...
========================================================
*/
-- Consulta 3: Reporte detallado e integral de inscripciones
SELECT 
    s.socio_id, 
...
========================================================
*/
-- Consulta 4: Total de socios inscritos por cada plan de entrenamiento
...
GROUP BY p.plan_entrenamiento_id, p.plan_entrenamiento
...
========================================================
*/
-- Consulta 5: Cantidad de socios asignados a cada entrenador
SELECT 
    e.nombre_entrenador, 
    ee.nombre_especialidad, 
